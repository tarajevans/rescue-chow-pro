        ...
        <div className="flex flex-row items-center justify-center space-x-8 mt-4">
          ...
          >
            <div className="flex-shrink-0">
              <Image className="h-8 w-8" src={facebook} alt="facebook link" />
            </div>
          </Link>
          <Link
          ...
          >
            <div className="flex-shrink-0">
              <Image className="h-8 w-8" src={instagram} alt="instagram link" />
            </div>
          </Link>
          <div className="flex-shrink-0">
            <Link
              ...
              target="_blank" rel="noopener noreferrer"
            >
              <Image className="h-8 w-8" src={linkedin} alt="linkedin link" />
            </Link>
          </div>
        </div>
      </div>
