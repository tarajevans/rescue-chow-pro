...
const Detail = ({ data }) => {
    ...
    const thisItem = JSON.parse(data);
                        ...
                        <div className="flex flex-col-reverse">
                            <div className="mt-4">
                                ...
                                <p className="mt-2 text-sm text-gray-500">
                                    ${getProceeds(currentProduct.price)} of this
                                    items price goes to your chosen charity.
                                </p>
                            </div>
                        </div>
...
export async function getServerSideProps({ params }) {
    ...
    const result = await Product.findOne({ _id: params.prodId });
