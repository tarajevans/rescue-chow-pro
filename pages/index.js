            ...
            <main className="pt-16" id="WhoWeAre">
                            ...
                            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                                <div className="sm:max-w-lg">
                                    ...
                                    <p className="mt-4 text-base text-gray-500">
                                        Our founder and team at Rescue Chow,
                                        have been long-time supporters of animal
                                        rescues, fostering programs, transport,
                                        and pet food banks. We have created a
                                        meaningful way to help with raising
                                        funds, to ensure the good work continues
                                        across Canada.
                                    </p>
                                    <p className="mt-4 text-base text-gray-500">
                                        Saving animals, ensuring they have food,
                                        vet care, transportation, finding loving
                                        homes, or being the voice for the
                                        voiceless… there is no better work. We
                                        are here to help!
                                    </p>
                ...
                <div className="flex flex-row items-center justify-center space-x-2 pt-28">
                    ...
                    <p className=" max-w-2xl text-xl text-red-400 drop-shadow-[0_0_2px_rgba(0,0,0,1)] font-serif lg:mx-auto">
                        ...
                        end of our platform to track and see how successful
                        ...
                        <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8  ">
                            <div className="px-28 flex justify-between align-center">
                                ...
                                <p className="text-lg font-serif text-gray-600 font-semibold w-1/3">
                                    Don't wait to subscribe to our service to
                                    help out animal rescue charities as well as
                                    feed your pets healthy treats! To get in
                                    touch with us, you can send us an email
                                    containing any questions or comments.
                                </p>
                            </div>
                        </div>
                    </div>
